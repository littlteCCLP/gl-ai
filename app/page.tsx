    ...
    <div className="flex flex-col min-h-[100dvh]">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white border-b max-w-[375px] mx-auto">
        <div className="flex items-center justify-between px-4 h-14">
          ...
          <button onClick={() => setShowProfileEdit(true)} className="w-10 h-10 rounded-full overflow-hidden">
      ...
      <main className="flex-1 pt-14 pb-20 overflow-y-auto">
        <div className="px-4">
          ...
          <div className="text-center py-3">
            <Image
              src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/fe6932720fda997c3b514dd58df8362-ByJblHUXrUMx2adBaJADDEhzMNoiDm.png"
              ...
              <Link href={card.link || "#"} key={index}>
                <Card className="p-3 hover:shadow-md transition-all duration-300 cursor-pointer h-full group">
                  <div className="flex flex-col items-center text-center h-full">
                    <div
                      className={`w-12 h-12 rounded-full ${card.bgColor} flex items-center justify-center mb-2 group-hover:scale-105 transition-transform duration-300`}
                    >
                      {card.icon}
                    </div>
                    <h3 className="font-semibold text-sm text-gray-800 mb-1 group-hover:text-blue-600 transition-colors duration-300">
                      {card.title}
                    </h3>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 bg-blue-50 max-w-[375px] mx-auto">
        <div className="px-4 py-3">
          <div className="relative flex items-center bg-white rounded-full shadow-sm">
            <Input
              ...
              className="w-full pl-12 pr-12 py-3 rounded-full border border-gray-200 focus:ring-0 focus:border-gray-200 bg-white"
            />
...
const featureCards = [
  ...
  },
  {
    ...
    icon: (
      <ShoppingCart className="w-6 h-6 text-purple-600 group-hover:text-purple-700 transition-colors duration-300" />
    ),
